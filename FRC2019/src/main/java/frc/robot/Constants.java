...
public class Constants
	{
		...
		public static final double VISION_AIM_MIN_SPEED_PERCENT = 0.08; //Minimum speed allowed when autoaligning (0 to 1)
		public static final double VISION_RANGE_MIN_SPEED_PERCENT = 0.1; //Minimum speed allowed when autoaligning (0 to 1)
		...
		public static final double VISION_ON_TARGET_INCH_RANGE = 3; //Vision range aiming will call itself good enough when within ±this
