...
public class Constants
	{
		...
		public static final int HATCH_GROUND_LOADER = 3; // The longer piston
		...
		// Hatch Ground Loader
		public static final int LEFT_H_LOADER_DRIVER = 14;
		public static final int RIGHT_H_LOADER_DRIVER = 24;
