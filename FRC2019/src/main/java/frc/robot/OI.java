...
public class OI {
	...
	public static final int CLIMB2_TOGGLE_FRONT = XBox360Controller.Button.LEFT_BUMPER.Number();
	public static final int CLIMB2_TOGGLE_REAR = XBox360Controller.Button.RIGHT_BUMPER.Number();
